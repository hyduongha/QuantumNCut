...
def main(name):
    ...
    input_path = "/content/drive/MyDrive/29055_b10_20230310_chengdu_id6061_2928x3904_K4/" + name
    excel_path = os.path.join("/content/drive/MyDrive/29055_b10_20230310_chengdu_id6061_2928x3904_K4/QuantumNcut/log"+numbers[0]+".xlsx")  # file Excel lưu
    output_path = "/content/drive/MyDrive/29055_b10_20230310_chengdu_id6061_2928x3904_K4/QuantumNcut/out"+numbers[0]
