...
def main(name):
    ...
    input_path = "/content/drive/MyDrive/15765_b08_20230224_yinchuan_id3137_2736x3648_K5/" + name
    excel_path = os.path.join("/content/drive/MyDrive/15765_b08_20230224_yinchuan_id3137_2736x3648_K5/QuantumNcut/log"+numbers[0]+".xlsx")  # file Excel lưu
    output_path = "/content/drive/MyDrive/15765_b08_20230224_yinchuan_id3137_2736x3648_K5/QuantumNcut/out"+numbers[0]
