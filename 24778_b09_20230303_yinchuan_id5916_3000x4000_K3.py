...
def main(name):
    ...
    input_path = "/content/drive/MyDrive/24778_b09_20230303_yinchuan_id5916_3000x4000_K3/" + name
    excel_path = os.path.join("/content/drive/MyDrive/24778_b09_20230303_yinchuan_id5916_3000x4000_K3/QuantumNcut/log"+numbers[0]+".xlsx")  # file Excel lưu
    output_path = "/content/drive/MyDrive/24778_b09_20230303_yinchuan_id5916_3000x4000_K3/QuantumNcut/out"+numbers[0]
