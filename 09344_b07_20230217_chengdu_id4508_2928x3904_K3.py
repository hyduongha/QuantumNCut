...
def main(name):
    ...
    input_path = "/content/drive/MyDrive/09344_b07_20230217_chengdu_id4508_2928x3904_K3/" + name
    excel_path = os.path.join("/content/drive/MyDrive/09344_b07_20230217_chengdu_id4508_2928x3904_K3/QuantumNcut/log"+numbers[0]+".xlsx")  # file Excel lưu
    output_path = "/content/drive/MyDrive/09344_b07_20230217_chengdu_id4508_2928x3904_K3/QuantumNcut/out"+numbers[0]
