...
def main(name):
    ...
    input_path = "/content/drive/MyDrive/09653_b07_20230217_chengdu_id4518_3072x4096_K4/" + name
    excel_path = os.path.join("/content/drive/MyDrive/09653_b07_20230217_chengdu_id4518_3072x4096_K4/QuantumNcut/log"+numbers[0]+".xlsx")  # file Excel lưu
    output_path = "/content/drive/MyDrive/09653_b07_20230217_chengdu_id4518_3072x4096_K4/QuantumNcut/out"+numbers[0]
