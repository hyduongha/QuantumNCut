...
def main(name):
    ...
    input_path = "/content/drive/MyDrive/06875_b06_20230210_tianjin_id3000_2448x3264_K6/" + name
    excel_path = os.path.join("/content/drive/MyDrive/06875_b06_20230210_tianjin_id3000_2448x3264_K6/QuantumNcut/log"+numbers[0]+".xlsx")  # file Excel lưu
    output_path = "/content/drive/MyDrive/06875_b06_20230210_tianjin_id3000_2448x3264_K6/QuantumNcut/out"+numbers[0]
