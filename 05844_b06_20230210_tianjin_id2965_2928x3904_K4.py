...
def main(name):
    ...
    input_path = "/content/drive/MyDrive/05844_b06_20230210_tianjin_id2965_2928x3904_K4/" + name
    excel_path = os.path.join("/content/drive/MyDrive/05844_b06_20230210_tianjin_id2965_2928x3904_K4/QuantumNcut/log"+numbers[0]+".xlsx")  # file Excel lưu
    output_path = "/content/drive/MyDrive/05844_b06_20230210_tianjin_id2965_2928x3904_K4/QuantumNcut/out"+numbers[0]
