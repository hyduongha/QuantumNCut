...
def main(name):
    ...
    input_path = "/content/drive/MyDrive/06120_b06_20230210_tianjin_id2974_2736x3648_K6/" + name
    excel_path = os.path.join("/content/drive/MyDrive/06120_b06_20230210_tianjin_id2974_2736x3648_K6/QuantumNcut/log"+numbers[0]+".xlsx")  # file Excel lưu
    output_path = "/content/drive/MyDrive/06120_b06_20230210_tianjin_id2974_2736x3648_K6/QuantumNcut/out"+numbers[0]
