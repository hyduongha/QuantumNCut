...
def main(name):
    ...
    input_path = "/content/drive/MyDrive/26075_b09_20230303_yinchuan_id5959_2736x3648_K4/" + name
    excel_path = os.path.join("/content/drive/MyDrive/26075_b09_20230303_yinchuan_id5959_2736x3648_K4/QuantumNcut/log"+numbers[0]+".xlsx")  # file Excel lưu
    output_path = "/content/drive/MyDrive/26075_b09_20230303_yinchuan_id5959_2736x3648_K4/QuantumNcut/out"+numbers[0]
