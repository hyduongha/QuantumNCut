...
def main(name):
    ...
    input_path = "/content/drive/MyDrive/15451_b08_20230224_yinchuan_id3126_3000x4000_K4/" + name
    excel_path = os.path.join("/content/drive/MyDrive/15451_b08_20230224_yinchuan_id3126_3000x4000_K4/QuantumNcut/log"+numbers[0]+".xlsx")  # file Excel lưu
    output_path = "/content/drive/MyDrive/15451_b08_20230224_yinchuan_id3126_3000x4000_K4/QuantumNcut/out"+numbers[0]
