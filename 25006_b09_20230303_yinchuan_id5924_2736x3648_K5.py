...
def main(name):
    ...
    input_path = "/content/drive/MyDrive/25006_b09_20230303_yinchuan_id5924_2736x3648_K5/" + name
    excel_path = os.path.join("/content/drive/MyDrive/25006_b09_20230303_yinchuan_id5924_2736x3648_K5/QuantumNcut/log"+numbers[0]+".xlsx")  # file Excel lưu
    output_path = "/content/drive/MyDrive/25006_b09_20230303_yinchuan_id5924_2736x3648_K5/QuantumNcut/out"+numbers[0]
