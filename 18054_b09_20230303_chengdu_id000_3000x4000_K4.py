...
def main(name):
    ...
    input_path = "/content/drive/MyDrive/18054_b09_20230303_chengdu_id000_3000x4000_K4/" + name
    excel_path = os.path.join("/content/drive/MyDrive/18054_b09_20230303_chengdu_id000_3000x4000_K4/QuantumNcut/log"+numbers[0]+".xlsx")  # file Excel lưu
    output_path = "/content/drive/MyDrive/18054_b09_20230303_chengdu_id000_3000x4000_K4/QuantumNcut/out"+numbers[0]
