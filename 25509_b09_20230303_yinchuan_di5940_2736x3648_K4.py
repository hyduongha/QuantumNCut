...
def main(name):
    ...
    excel_path = os.path.join("/content/drive/MyDrive/25509_b09_20230303_yinchuan_di5940_2736x3648_K4/QuantumNcut/log"+numbers[0]+".xlsx")  # file Excel lưu
    output_path = "/content/drive/MyDrive/25509_b09_20230303_yinchuan_di5940_2736x3648_K4/QuantumNcut/out"+numbers[0]
