...
def main(name):
    ...
    input_path = "/content/drive/MyDrive/25912_b09_20230303_yinchuan_id5954_2976x3968_K4/" + name
    excel_path = os.path.join("/content/drive/MyDrive/25912_b09_20230303_yinchuan_id5954_2976x3968_K4/QuantumNcut/log"+numbers[0]+".xlsx")  # file Excel lưu
    output_path = "/content/drive/MyDrive/25912_b09_20230303_yinchuan_id5954_2976x3968_K4/QuantumNcut/out"+numbers[0]
