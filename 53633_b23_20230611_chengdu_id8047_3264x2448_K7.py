...
def main(name):
    ...
    input_path = "/content/drive/MyDrive/53633_b23_20230611_chengdu_id8047_3264x2448_K7/" + name
    excel_path = os.path.join("/content/drive/MyDrive/53633_b23_20230611_chengdu_id8047_3264x2448_K7/QuantumNcut/log"+numbers[0]+".xlsx")  # file Excel lưu
    output_path = "/content/drive/MyDrive/53633_b23_20230611_chengdu_id8047_3264x2448_K7/QuantumNcut/out"+numbers[0]
