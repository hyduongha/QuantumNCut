...
def main(name):
    ...
    input_path = "/content/drive/MyDrive/56803_b26_20230703_tianjin_id8154_4096x3072_K3/" + name
    excel_path = os.path.join("/content/drive/MyDrive/56803_b26_20230703_tianjin_id8154_4096x3072_K3/QuantumNcut/log"+numbers[0]+".xlsx")  # file Excel lưu
    output_path = "/content/drive/MyDrive/56803_b26_20230703_tianjin_id8154_4096x3072_K3/QuantumNcut/out"+numbers[0]
